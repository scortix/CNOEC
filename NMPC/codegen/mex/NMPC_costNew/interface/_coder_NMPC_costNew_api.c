 ...
 *
 * _coder_NMPC_costNew_api.c
 *
 * Code generation for function '_coder_NMPC_costNew_api'
 *
 */
...
void NMPC_costNew_api(const mxArray *const prhs[10], const mxArray **plhs)
{
  emlrtStack st = {
      NULL, /* site */
      NULL, /* tls */
  ...
  NMPC_costNew(&st, M, Ts, x, *b_y0, yref, *Q, R, coeffT, m0, Tmax, J);
...
/* End of code generation (_coder_NMPC_costNew_api.c) */
