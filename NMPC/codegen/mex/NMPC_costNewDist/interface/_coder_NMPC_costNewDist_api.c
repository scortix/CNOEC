 ...
 *
 * _coder_NMPC_costNewDist_api.c
 *
 * Code generation for function '_coder_NMPC_costNewDist_api'
 *
 */
...
static emlrtRTEInfo db_emlrtRTEI = {
    1,                             /* lineNo */
    1,                             /* colNo */
    "_coder_NMPC_costNewDist_api", /* fName */
    ""                             /* pName */
};
...
void NMPC_costNewDist_api(const mxArray *const prhs[13], const mxArray **plhs)
{
  emlrtStack st = {
      NULL, /* site */
      NULL, /* tls */
  ...
  emxInit_real_T(&st, &x, 1, &db_emlrtRTEI);
  emxInit_real_T(&st, &yref, 2, &db_emlrtRTEI);
  emxInit_real_T(&st, &J, 1, &db_emlrtRTEI);
  ...
  NMPC_costNewDist(&st, M, Ts, x, *b_y0, yref, *Q, R, coeffT, m0, Tmax, *xp,
                   *yp, *zp, J);
...
/* End of code generation (_coder_NMPC_costNewDist_api.c) */
