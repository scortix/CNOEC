...
static emlrtRSInfo r_emlrtRSI = {
    ...
    "Project\\OrbitPropagator\\Unconstrained\\EOE2COE.m" /* pathName */
};
...
void EOE2COE(const emlrtStack *sp, const real_T x[6], real_T y[6])
{
  ...
  /*    Orbital Elements. */
  /*    COE = EOE2COE(EOE) receives as input a vector of the 6 equinoctial  */
  /*    Orbital Elements and gives as output a column vector of the 6 classical
   */
  /*    Orbital Elements. */
