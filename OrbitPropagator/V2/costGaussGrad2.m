function [J, f, gx, hx, Jf, Jg, Jh, p, q] = costGaussGrad2(x,tmax,Ts,y0,ybar,m0,coeffT,Tmax,ratio,alpha,computeGrad,A,b,C,d)
...
J = [f;g;h];
if computeGrad
    Jac = mygradcalc(@(x)costGaussGrad2(x,tmax,Ts,y0,ybar,m0,coeffT,Tmax,ratio,alpha,false,[],[],[],[]),x, J, 'FD');
    Jf = Jac(:,1);
