 ...
 *
 * _coder_costGaussGradtf_api.c
 *
 * Code generation for function '_coder_costGaussGradtf_api'
 *
 */
...
static emlrtRTEInfo vc_emlrtRTEI = {
    1,                            /* lineNo */
    1,                            /* colNo */
    "_coder_costGaussGradtf_api", /* fName */
    ""                            /* pName */
};
...
void costGaussGradtf_api(const mxArray *const prhs[15], int32_T nlhs,
                         const mxArray *plhs[11])
{
  ...
  emxInit_real_T(&st, &JF, 2, &vc_emlrtRTEI);
  ...
  costGaussGradtf(&st, x, tmax, Ts, *b_y0, *ybar, m0, coeffT, Tmax, ratio,
                  alpha, computeGrad, A, b, C, d, J, &f, gx, hx, Jf, Jg, Jh, &p,
                  &q, *F, JF);
...
/* End of code generation (_coder_costGaussGradtf_api.c) */
