...
static void b_binary_expand_op(const emlrtStack *sp, emxArray_real_T *r,
...
static void c_binary_expand_op(const emlrtStack *sp, emxArray_real_T *y,
                               const emxArray_real_T *r1);

static void d_binary_expand_op(const emlrtStack *sp, emxArray_real_T *r1,
                               const emxArray_real_T *y);
                               ...
                               const emxArray_real_T *b_y)
{
  ...
  emxEnsureCapacity_real_T(sp, r, stride_0_0, &fc_emlrtRTEI);
  r_data = r->data;
  stride_0_0 = (i != 1);
  ...
  for (i = 0; i < loop_ub; i++) {
    r_data[i] = b_y_data[6 * (i * stride_0_0)] / y_data[i * stride_1_0];
  }
}
                             ...
                             const emxArray_real_T *d)
{
  ...
  if (d->size[0] == 1) {
    varargin_1->size[0] = unnamed_idx_0;
  } else {
    varargin_1->size[0] = d->size[0];
  }
  varargin_1->size[1] = d->size[1];
  emxEnsureCapacity_real_T(sp, varargin_1, i, &nb_emlrtRTEI);
  ...
  for (i = 0; i < loop_ub; i++) {
    ...
    for (i1 = 0; i1 < b_loop_ub; i1++) {
      varargin_1_data[i1] = r[i1 * stride_0_0] - d_data[i1 * stride_1_0];
    }
  }
}
                               ...
                               const emxArray_real_T *r1)
{
  ...
  emxEnsureCapacity_real_T(sp, b_y, i, &dc_emlrtRTEI);
  b_y_data = b_y->data;
  ...
  y->size[0] = 1;
  y->size[1] = b_y->size[1];
  emxEnsureCapacity_real_T(sp, y, i, &dc_emlrtRTEI);
  y_data = y->data;
  loop_ub = b_y->size[1];
  for (i = 0; i < loop_ub; i++) {
    y_data[i] = b_y_data[i];
                               ...
                               const emxArray_real_T *y)
{
  ...
  r = r1->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtCTX)sp);
  emxInit_real_T(sp, &b_y, 2, &yc_emlrtRTEI);
  i = y->size[1];
  ...
  emxEnsureCapacity_real_T(sp, b_y, stride_0_1, &yc_emlrtRTEI);
  b_y_data = b_y->data;
  stride_0_1 = (i != 1);
  stride_1_1 = (r1->size[1] != 1);
  if (r1->size[1] == 1) {
  ...
  emxEnsureCapacity_real_T(sp, r1, i, &yc_emlrtRTEI);
  r = r1->data;
  loop_ub = b_y->size[1];
  for (i = 0; i < loop_ub; i++) {
    r[i] = b_y_data[i];
                 ...
                 const emxArray_real_T *t)
{
  ...
  y_data = y->data;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtCTX)sp);
  emxInit_real_T(sp, &b_y, 2, &vb_emlrtRTEI);
  i = b_y->size[0] * b_y->size[1];
  b_y->size[0] = 1;
  if (t->size[1] == 1) {
    b_y->size[1] = y->size[1];
  ...
  emxEnsureCapacity_real_T(sp, b_y, i, &vb_emlrtRTEI);
  b_y_data = b_y->data;
  stride_0_1 = (y->size[1] != 1);
                        ...
                        real_T g[5], emxArray_real_T *h)
{
  ...
  emxEnsureCapacity_real_T(sp, b_x, i, &rc_emlrtRTEI);
  b_x_data = b_x->data;
  ...
  for (i = 0; i < loop_ub; i++) {
    b_x_data[i] = x_data[i * stride_0_0] + r[i * stride_1_0];
  }
  for (i1 = 0; i1 < 6; i1++) {
    b_fun_workspace_y0[i1] = fun_workspace_y0[i1];
  }
  st.site = &rc_emlrtRSI;
  fun(&st, b_x, fun_workspace_tmax, fun_workspace_Ts, b_fun_workspace_y0,
         ...
         real_T Tmax, real_T ratio, real_T g[5], emxArray_real_T *h)
{
  ...
  emxArray_int32_T_1x1 rc_emlrtRSI;
  emxArray_real_T c_x;
  emxArray_real_T *b_r;
  emxArray_real_T *b_x;
  emxArray_real_T *b_y;
  ...
  if (muDoubleScalarIsNaN(Ts) || muDoubleScalarIsNaN(tmax)) {
    ...
    maxdimlen = t->size[0] * t->size[1];
    t->size[0] = 1;
    idx = (int32_T)muDoubleScalarFloor(tmax / Ts);
    t->size[1] = idx + 1;
    emxEnsureCapacity_real_T(&st, t, maxdimlen, &sb_emlrtRTEI);
    t_data = t->data;
    for (maxdimlen = 0; maxdimlen <= idx; maxdimlen++) {
  ...
  eml_find(&b_st, b_t, rc_emlrtRSI.data, rc_emlrtRSI.size);
  st.site = &m_emlrtRSI;
  EOE2COE(&st, b_y0, x0);
  st.site = &n_emlrtRSI;
  ...
  emxInit_real_T(sp, &b_x, 1, &xb_emlrtRTEI);
  for (k = 0; k < maxdimlen; k++) {
    ...
    for (idx = 0; idx < 3; idx++) {
      i3 = b_x->size[0];
      b_x->size[0] = i4 - i2;
      emxEnsureCapacity_real_T(sp, b_x, i3, &xb_emlrtRTEI);
      r_data = b_x->data;
    ...
    st.site = &o_emlrtRSI;
    EOEDerivatives(&st, *(real_T(*)[6]) & y_data[6 * k], a, x0);
    if (k + 1 > y->size[1]) {
  ...
  r_data = b_y->data;
  for (i = 0; i < idx; i++) {
    r_data[i] = y_data[6 * i + 1];
  }
  emxInit_real_T(sp, &d_y, 2, &dc_emlrtRTEI);
  st.site = &p_emlrtRSI;
  power(&st, b_y, d_y);
  idx = y->size[1];
  i = b_y->size[0] * b_y->size[1];
  b_y->size[0] = 1;
  b_y->size[1] = y->size[1];
  emxEnsureCapacity_real_T(sp, b_y, i, &wb_emlrtRTEI);
  r_data = b_y->data;
  for (i = 0; i < idx; i++) {
  ...
  power(&st, b_y, t);
  t_data = t->data;
  if ((d_y->size[1] != t->size[1]) &&
      ((d_y->size[1] != 1) && (t->size[1] != 1))) {
    emlrtDimSizeImpxCheckR2021b(d_y->size[1], t->size[1], &g_emlrtECI,
                                (emlrtCTX)sp);
  }
  idx = y->size[1];
  i = b_y->size[0] * b_y->size[1];
  ...
  if (d_y->size[1] == t->size[1]) {
    ...
    d_y->size[0] = 1;
    emxEnsureCapacity_real_T(sp, d_y, i, &bc_emlrtRTEI);
    qdir_data = d_y->data;
    for (i = 0; i <= idx; i++) {
  ...
  b_cos(&st, r);
  r_data = r->data;
  if ((d_y->size[1] != r->size[1]) &&
      ((d_y->size[1] != 1) && (r->size[1] != 1))) {
    emlrtDimSizeImpxCheckR2021b(d_y->size[1], r->size[1], &e_emlrtECI,
                                (emlrtCTX)sp);
  }
  st.site = &p_emlrtRSI;
  if (d_y->size[1] == r->size[1]) {
    ...
    i = d_y->size[0] * d_y->size[1];
    d_y->size[0] = 1;
    emxEnsureCapacity_real_T(&st, d_y, i, &dc_emlrtRTEI);
    qdir_data = d_y->data;
    for (i = 0; i <= idx; i++) {
  ...
  b_y->size[0] = 1;
  b_y->size[1] = y->size[1];
  emxEnsureCapacity_real_T(&b_st, b_y, i, &ec_emlrtRTEI);
  r_data = b_y->data;
  for (i = 0; i < idx; i++) {
    r_data[i] = y_data[6 * i];
  }
  c_st.site = &sb_emlrtRSI;
  assertCompatibleDims(&c_st, b_y, d_y);
  emxFree_real_T(sp, &b_y);
  emxInit_real_T(sp, &b_r, 1, &fc_emlrtRTEI);
  if (y->size[1] == d_y->size[1]) {
    idx = y->size[1];
    i = b_r->size[0];
    b_r->size[0] = y->size[1];
    ...
    st.site = &p_emlrtRSI;
    b_binary_expand_op(&st, b_r, y, d_y);
    r_data = b_r->data;
  }
  ...
  i = b_x->size[0];
  b_x->size[0] = loop_ub;
  emxEnsureCapacity_real_T(sp, b_x, i, &xb_emlrtRTEI);
  r_data = b_x->data;
  for (i = 0; i < loop_ub; i++) {
