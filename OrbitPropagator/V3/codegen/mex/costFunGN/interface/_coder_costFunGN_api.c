 ...
 *
 * _coder_costFunGN_api.c
 *
 * Code generation for function '_coder_costFunGN_api'
 *
 */
...
void costFunGN_api(const mxArray *const prhs[10], int32_T nlhs,
                   const mxArray *plhs[4])
{
  ...
  emxInit_real_T(&st, &x, 1, &cb_emlrtRTEI);
  emxInit_real_T(&st, &J, 1, &cb_emlrtRTEI);
  emxInit_real_T(&st, &y, 2, &cb_emlrtRTEI);
  ...
  costFunGN(&st, x, Ts, tmax, *b_y0, *ybar, ratio, Tmax, coeffT, m0, alpha, J,
            y, &tCost, &m);
...
/* End of code generation (_coder_costFunGN_api.c) */
