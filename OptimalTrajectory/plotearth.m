function h = plotearth(fig,varargin)
...
try % sometime memory problem occurs
    ...
    ax1=ax.Children;
    ax1.XData=ax1.XData*6378.137;
    ax1.YData=ax1.YData*6378.137;
    ax1.ZData=ax1.ZData*6378.137;
    %f=ax.Children
    %ax.Position(3:4)=ax.Position(3:4)*1000
    view(ax,viewpoint);
    if nargout>=1
        % return the handle
        h = ax;
